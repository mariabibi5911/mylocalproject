...
public class ClassDefRewriter implements Rewriter<ClassDef> {
    ...
    public class RewrittenClassDef extends BaseTypeReference implements ClassDef {
        ...
        public Iterable<? extends Field> getFields() {
            return new Iterable<Field>() { // from class: com.android.tools.smali.dexlib2.rewriter.ClassDefRewriter.RewrittenClassDef.1
        ...
        public Iterable<? extends Method> getMethods() {
            return new Iterable<Method>() { // from class: com.android.tools.smali.dexlib2.rewriter.ClassDefRewriter.RewrittenClassDef.2
                @Override // java.lang.Iterable
                @Nonnull
