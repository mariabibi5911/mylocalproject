...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] upperBounds) {
            ...
            String join = Joiner.on(Typography.amp).join(upperBounds);
            String name = new StringBuilder(String.valueOf(join).length() + 33).append("capture#").append(incrementAndGet).append("-of ? extends ").append(join).toString();
