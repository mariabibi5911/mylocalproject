...
public final class MediaType {
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            String type = tokenizer.consumeToken(charMatcher);
            tokenizer.consumeCharacter('/');
            String subtype = tokenizer.consumeToken(charMatcher);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            Multimap<String, String> quotedParameters = Multimaps.transformValues((ListMultimap) this.parameters, new Function() { // from class: com.google.common.net.MediaType$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
    ...
    public static /* synthetic */ String lambda$computeToString$0(String value) {
