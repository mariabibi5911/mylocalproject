...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Landroid/graphics/Rect;"}, k = 3, mv = {1, 7, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<ProducerScope<? super Rect>, Continuation<? super Unit>, Object> {
            ...
            case 0:
                ...
                final View.OnLayoutChangeListener layoutChangeListener = new View.OnLayoutChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$$ExternalSyntheticLambda0
                    ...
                    public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                        PipHintTrackerKt$trackPipAnimationHintView$flow$1.m4invokeSuspend$lambda0(ProducerScope.this, view, i, i2, i3, i4, i5, i6, i7, i8);
                    }
                };
                ...
                final ?? r5 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                    ...
                    public void onViewAttachedToWindow(View v) {
                        ...
                        producerScope.mo1659trySendJP2dKIU(trackPipAnimationHintView$positionInWindow2);
                ...
                if (Api19Impl.INSTANCE.isAttachedToWindow(this.$view)) {
                    ...
                    $this$callbackFlow.mo1659trySendJP2dKIU(trackPipAnimationHintView$positionInWindow);
    ...
    public static final void m4invokeSuspend$lambda0(ProducerScope $$this$callbackFlow, View v, int l, int t, int r, int b, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        Rect trackPipAnimationHintView$positionInWindow;
    ...
    public static final void m5invokeSuspend$lambda1(ProducerScope $$this$callbackFlow, View $view) {
        Rect trackPipAnimationHintView$positionInWindow;
