...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    */
    boolean scrollByInternal(int x, int y, MotionEvent ev, int type) {
        ...
        dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, this.mScrollOffset, type, iArr3);
        int[] iArr4 = this.mReusableIntPair;
        int i = iArr4[0];
        int unconsumedX3 = unconsumedX - i;
        int i2 = iArr4[1];
        int unconsumedY3 = unconsumedY - i2;
        boolean consumedNestedScroll = (i == 0 && i2 == 0) ? false : true;
        int i3 = this.mLastTouchX;
        int[] iArr5 = this.mScrollOffset;
        int i4 = iArr5[0];
        this.mLastTouchX = i3 - i4;
        int i5 = this.mLastTouchY;
        int i6 = iArr5[1];
        this.mLastTouchY = i5 - i6;
    ...
    */
    ...
    private float getSplineFlingDistance(int velocity) {
        ...
        return (float) (this.mPhysicalCoef * SCROLL_FRICTION * Math.exp((f / decelMinusOne) * l));
    }
        ...
        public void run() {
            ...
            if (RecyclerView.this.mLayout != null) {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (recyclerView.dispatchNestedPreScroll(unconsumedX2, unconsumedY2, recyclerView.mReusableIntPair, null, 1)) {
                    ...
                    if (RecyclerView.this.mAdapter != null) {
                        ...
                        recyclerView2.scrollStep(unconsumedX2, unconsumedY2, recyclerView2.mReusableIntPair);
                    ...
                    recyclerView3.dispatchNestedScroll(consumedX, consumedY, unconsumedX2, unconsumedY2, null, 1, recyclerView3.mReusableIntPair);
                    ...
                    boolean doneScrolling = scroller.isFinished() || ((scrollerFinishedX || unconsumedX3 != 0) && (scrollerFinishedY || unconsumedY3 != 0));
                    ...
                    if (!smoothScrollerPending && doneScrolling) {
                        if (RecyclerView.this.getOverScrollMode() != 2) {
                            ...
                            int velX = unconsumedX3 < 0 ? -vel : unconsumedX3 > 0 ? vel : 0;
    ...
    public static class RecycledViewPool {
        ...
        public void putRecycledView(ViewHolder scrap) {
            ...
            if (this.mScrap.get(viewType).mMaxScrap <= scrapHeap.size()) {
                ...
                if (RecyclerView.sDebugAssertionsEnabled && scrapHeap.contains(scrap)) {
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder holder, int offsetPosition, int position, long deadlineNs) {
            ...
            if (holder.isTmpDetached()) {
                RecyclerView.this.attachViewToParent(holder.itemView, RecyclerView.this.getChildCount(), holder.itemView.getLayoutParams());
                reattachedForBind = true;
            }
            RecyclerView.this.mAdapter.bindViewHolder(holder, offsetPosition);
            if (reattachedForBind) {
                RecyclerView.this.detachViewFromParent(holder.itemView);
            }
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (holder2 != null) {
                ...
                if (holder2 == null) {
                    if (RecyclerView.sVerboseLoggingEnabled) {
                        Log.d(RecyclerView.TAG, "tryGetViewHolderForPositionByDeadline(" + position + ") fetching from shared pool");
                    }
        ...
        void offsetPositionRecordsForMove(int from, int to) {
            ...
            for (int i = 0; i < cachedCount; i++) {
                ...
                if (holder != null && holder.mPosition >= start && holder.mPosition <= end) {
                    ...
                    if (RecyclerView.sVerboseLoggingEnabled) {
                        Log.d(RecyclerView.TAG, "offsetPositionRecordsForMove cached child " + i + " holder " + holder);
                    }
                }
            }
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH holder, int position) {
            ...
            if (RecyclerView.sDebugAssertionsEnabled) {
                ...
                if (holder.itemView.getParent() == null && ViewCompat.isAttachedToWindow(holder.itemView)) {
