...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public /* synthetic */ Bundle m44lambda$init$0$androidxfragmentappFragmentActivity() {
    ...
    public /* synthetic */ void m45lambda$init$1$androidxfragmentappFragmentActivity(Configuration newConfig) {
        this.mFragments.noteStateNotSaved();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$init$2$androidx-fragment-app-FragmentActivity, reason: not valid java name */
    public /* synthetic */ void m46lambda$init$2$androidxfragmentappFragmentActivity(Intent newConfig) {
        this.mFragments.noteStateNotSaved();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$init$3$androidx-fragment-app-FragmentActivity, reason: not valid java name */
    public /* synthetic */ void m47lambda$init$3$androidxfragmentappFragmentActivity(Context context) {
