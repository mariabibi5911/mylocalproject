...
public final class FragmentViewModelLazyKt$viewModels$4 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public final ViewModelProvider.Factory invoke() {
        ViewModelStoreOwner m57viewModels$lambda0;
        ViewModelProvider.Factory defaultViewModelProviderFactory;
        m57viewModels$lambda0 = FragmentViewModelLazyKt.m57viewModels$lambda0(this.$owner$delegate);
        HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = m57viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) m57viewModels$lambda0 : null;
