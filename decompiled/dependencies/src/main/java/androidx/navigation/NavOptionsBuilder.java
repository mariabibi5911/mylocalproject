...
public final class NavOptionsBuilder {
    ...
    public final NavOptions build$navigation_common_release() {
        ...
        $this$build_u24lambda_u2d2.setLaunchSingleTop(this.launchSingleTop);
        $this$build_u24lambda_u2d2.setRestoreState(this.restoreState);
        String str = this.popUpToRoute;
        if (str != null) {
            $this$build_u24lambda_u2d2.setPopUpTo(str, this.inclusive, this.saveState);
        } else {
            $this$build_u24lambda_u2d2.setPopUpTo(this.popUpToId, this.inclusive, this.saveState);
        }
