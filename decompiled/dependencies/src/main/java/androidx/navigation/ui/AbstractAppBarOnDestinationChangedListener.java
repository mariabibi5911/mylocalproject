...
public abstract class AbstractAppBarOnDestinationChangedListener implements NavController.OnDestinationChangedListener {
    ...
    public AbstractAppBarOnDestinationChangedListener(Context context, AppBarConfiguration configuration) {
        ...
        this.openableLayoutWeakReference = $this$openableLayoutWeakReference_u24lambda_u2d0 != null ? new WeakReference<>($this$openableLayoutWeakReference_u24lambda_u2d0) : null;
    }
        ...
        if (label != null) {
            ...
            while (matcher.find()) {
                ...
                if (arguments != null && arguments.containsKey(argName)) {
                    ...
                    throw new IllegalArgumentException("Could not find \"" + argName + "\" in " + arguments + " to fill label \"" + ((Object) label) + Typography.quote);
                }
            }
    ...
    private final void setActionBarUpIndicator(boolean showAsDrawerIndicator) {
        ...
        if ($this$setActionBarUpIndicator_u24lambda_u2d1 == null || (pair = TuplesKt.to($this$setActionBarUpIndicator_u24lambda_u2d1, true)) == null) {
