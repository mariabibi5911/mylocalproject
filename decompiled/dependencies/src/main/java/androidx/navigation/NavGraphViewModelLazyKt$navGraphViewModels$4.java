...
public final class NavGraphViewModelLazyKt$navGraphViewModels$4 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public final ViewModelProvider.Factory invoke() {
        NavBackStackEntry m72navGraphViewModels$lambda1;
        m72navGraphViewModels$lambda1 = NavGraphViewModelLazyKt.m72navGraphViewModels$lambda1(this.$backStackEntry$delegate);
        return m72navGraphViewModels$lambda1.getDefaultViewModelProviderFactory();
    }
}
