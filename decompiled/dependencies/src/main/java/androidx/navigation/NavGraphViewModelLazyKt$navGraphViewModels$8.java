...
public final class NavGraphViewModelLazyKt$navGraphViewModels$8 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public final ViewModelProvider.Factory invoke() {
        NavBackStackEntry m74navGraphViewModels$lambda3;
        m74navGraphViewModels$lambda3 = NavGraphViewModelLazyKt.m74navGraphViewModels$lambda3(this.$backStackEntry$delegate);
        return m74navGraphViewModels$lambda3.getDefaultViewModelProviderFactory();
    }
}
