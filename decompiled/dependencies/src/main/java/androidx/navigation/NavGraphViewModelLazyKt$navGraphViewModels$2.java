...
public final class NavGraphViewModelLazyKt$navGraphViewModels$2 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public final ViewModelProvider.Factory invoke() {
        NavBackStackEntry m71navGraphViewModels$lambda0;
        m71navGraphViewModels$lambda0 = NavGraphViewModelLazyKt.m71navGraphViewModels$lambda0(this.$backStackEntry$delegate);
        return m71navGraphViewModels$lambda0.getDefaultViewModelProviderFactory();
    }
}
