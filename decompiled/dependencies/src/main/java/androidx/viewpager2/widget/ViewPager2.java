...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.ViewPager2, attrs, a, 0, 0);
        try {
    ...
    public abstract class AccessibilityProvider {
        ...
        void onLmInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
        }
