...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            ...
            for (int ix = 0; ix < FragmentStateAdapter.this.mFragments.size(); ix++) {
                ...
                if (fragment.isAdded()) {
                    if (itemId != this.mPrimaryItemId) {
                        ...
                        onPost.add(FragmentStateAdapter.this.mFragmentEventDispatcher.dispatchMaxLifecyclePreUpdated(fragment, Lifecycle.State.STARTED));
                    } else {
                        toResume = fragment;
                    }
            ...
            if (toResume != null) {
                ...
                onPost.add(FragmentStateAdapter.this.mFragmentEventDispatcher.dispatchMaxLifecyclePreUpdated(toResume, Lifecycle.State.RESUMED));
            }
    ...
    public static abstract class FragmentTransactionCallback {
        ...
        public OnPostEventListener onFragmentMaxLifecyclePreUpdated(Fragment fragment, Lifecycle.State maxLifecycleState) {
            return NO_OP;
        }
    }

    public void registerFragmentTransactionCallback(FragmentTransactionCallback callback) {
        this.mFragmentEventDispatcher.registerCallback(callback);
    }

    public void unregisterFragmentTransactionCallback(FragmentTransactionCallback callback) {
