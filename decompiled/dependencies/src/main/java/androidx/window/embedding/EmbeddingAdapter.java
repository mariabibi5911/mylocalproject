...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            ...
            public final boolean test(Object obj) {
                boolean m94translateActivityPairPredicates$lambda1;
                m94translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m94translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m94translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public static final boolean m94translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair $dstr$first$second) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m93translateActivityIntentPredicates$lambda3;
                m93translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m93translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m93translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public static final boolean m93translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair $dstr$first$second) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue($dstr$first$second, "(first, second)");
        Activity first = (Activity) this$0.component1($dstr$first$second);
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m97translateParentMetricsPredicate$lambda4;
                m97translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m97translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m97translateParentMetricsPredicate$lambda4;
            }
        };
    }
    ...
    public static final boolean m97translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        Intrinsics.checkNotNullParameter(splitRule, "$splitRule");
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m95translateActivityPredicates$lambda6;
                m95translateActivityPredicates$lambda6 = EmbeddingAdapter.m95translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m95translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public static final boolean m95translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m96translateIntentPredicates$lambda8;
                m96translateIntentPredicates$lambda8 = EmbeddingAdapter.m96translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m96translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    public static final boolean m96translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set $this$any$iv = activityFilters;
        if (($this$any$iv instanceof Collection) && $this$any$iv.isEmpty()) {
            return false;
