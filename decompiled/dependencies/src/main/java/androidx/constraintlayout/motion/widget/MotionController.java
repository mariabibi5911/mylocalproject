    ...
    */
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (hashMap2 == null) {
            ...
            Iterator<ViewTimeCycle> it2 = hashMap2.values().iterator();
        ...
        if (curveFitArr != null) {
            ...
            if (hashMap3 != null) {
                for (SplineSet aSpline2 : hashMap3.values()) {
            ...
            if (this.mEndMotionPath.width != this.mStartMotionPath.width || this.mEndMotionPath.height != this.mStartMotionPath.height || this.mForceMeasure) {
                int widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(width, 1073741824);
                int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(height, 1073741824);
