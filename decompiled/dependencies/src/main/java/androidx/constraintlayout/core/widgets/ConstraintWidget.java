                            ...
                            if (beginWidget2 != parent2) {
                                ...
                                if (applyRangeCheck) {
                                    ...
                                    if (!parentWrapContent2 || beginTarget2 == endTarget2 || variableSize2) {
                                        ...
                                        begin3 = begin2;
                                        system.addGreaterThan(begin3, beginTarget2, beginAnchor.getMargin(), rangeCheckStrength3);
                                        system.addLowerThan(end3, endTarget2, -endAnchor.getMargin(), rangeCheckStrength3);
