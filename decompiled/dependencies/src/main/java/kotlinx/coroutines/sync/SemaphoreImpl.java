...
public final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                        m1707constructorimpl = SegmentOrClosed.m1707constructorimpl(ConcurrentLinkedListKt.CLOSED);
                        break;
                    }
                    ...
                    m1707constructorimpl = SegmentOrClosed.m1707constructorimpl(cur$iv$iv);
                    curTail = s$iv2;
                    break;
                }
            }
            s$iv = m1707constructorimpl;
            if (SegmentOrClosed.m1712isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1710getSegmentimpl(s$iv);
            while (true) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1710getSegmentimpl(s$iv);
        i2 = SemaphoreKt.SEGMENT_SIZE;
        int i3 = (int) (enqIdx % i2);
        if (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(segment.acquirers, i3, null, cont)) {
            expected$iv = SemaphoreKt.PERMIT;
            value$iv = SemaphoreKt.TAKEN;
            if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(segment.acquirers, i3, expected$iv, value$iv)) {
                cont.resume(Unit.INSTANCE, this.onCancellationRelease);
                return true;
            }
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        if (value$iv2 == null) {
            ...
            return !Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(segment.acquirers, i4, expected$iv, value$iv);
        }
