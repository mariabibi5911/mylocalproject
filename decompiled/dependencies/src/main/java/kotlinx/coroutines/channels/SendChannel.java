...
public interface SendChannel<E> {
    ...
    Object mo1659trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1659trySendJP2dKIU(e);
            if (ChannelResult.m1674isSuccessimpl(result)) {
                return true;
            }
            Throwable m1668exceptionOrNullimpl = ChannelResult.m1668exceptionOrNullimpl(result);
