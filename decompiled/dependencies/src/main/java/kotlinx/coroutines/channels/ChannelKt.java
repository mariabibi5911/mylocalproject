...
public final class ChannelKt {
    ...
    public static final <T> T m1660getOrElseWpGqRn0(Object obj, Function1<? super Throwable, ? extends T> function1) {
        return obj instanceof ChannelResult.Failed ? function1.invoke(ChannelResult.m1668exceptionOrNullimpl(obj)) : obj;
    }

    /* renamed from: onSuccess-WpGqRn0 */
    public static final <T> Object m1663onSuccessWpGqRn0(Object $this$onSuccess, Function1<? super T, Unit> function1) {
    ...
    public static final <T> Object m1662onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> function1) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1668exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m1661onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> function1) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m1668exceptionOrNullimpl($this$onClosed));
        }
