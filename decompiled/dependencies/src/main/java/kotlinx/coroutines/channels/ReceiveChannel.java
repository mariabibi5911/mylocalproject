...
public interface ReceiveChannel<E> {
    ...
    Object mo1657receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1658tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1658tryReceivePtdJZtk = receiveChannel.mo1658tryReceivePtdJZtk();
            if (ChannelResult.m1674isSuccessimpl(mo1658tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1670getOrThrowimpl(mo1658tryReceivePtdJZtk);
            }
            Throwable m1668exceptionOrNullimpl = ChannelResult.m1668exceptionOrNullimpl(mo1658tryReceivePtdJZtk);
            if (m1668exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1668exceptionOrNullimpl);
        }
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (receiveChannel$receiveOrNull$12.label) {
                        case 0:
                            ...
                            mo1657receiveCatchingJP2dKIU = receiveChannel.mo1657receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$12);
                        ...
                        case 1:
                            ResultKt.throwOnFailure($result);
                            mo1657receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                            break;
                        default:
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    return ChannelResult.m1669getOrNullimpl(mo1657receiveCatchingJP2dKIU);
                }
            }
