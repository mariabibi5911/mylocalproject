...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1657receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
                ...
                switch (abstractChannel$receiveCatching$12.label) {
                    case 0:
                        ...
                        if (result != AbstractChannelKt.POLL_FAILED) {
                            return result instanceof Closed ? ChannelResult.INSTANCE.m1677closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1679successJP2dKIU(result);
                        }
    ...
    public final Object mo1658tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1678failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1677closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1679successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1695constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1703remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1700plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1656onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1664boximpl(ChannelResult.INSTANCE.m1677closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1664boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1677closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1679successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m168constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1664boximpl(ChannelResult.INSTANCE.m1679successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m168constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m168constructorimpl(ChannelResult.m1664boximpl(ChannelResult.INSTANCE.m1677closedJP2dKIU(closed.closeCause))));
            }
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1664boximpl(ChannelResult.INSTANCE.m1679successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1664boximpl(ChannelResult.INSTANCE.m1677closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        return;
                    default:
                        return;
                }
