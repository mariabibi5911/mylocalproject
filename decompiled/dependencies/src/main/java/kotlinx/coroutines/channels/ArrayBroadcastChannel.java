...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:47:0x00b8, code lost:
        ...
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L55;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x00d0, code lost:
        ...
        r27.buffer[(int) (r10 % getCapacity())] = r21.getElement();
        setSize(r0 + 1);
        setTail(r10 + 1);
                                    ...
                                    while (true) {
                                        ...
                                        try {
                                            if (takeFirstSendOrPeekClosed instanceof Closed) {
                                                ...
                                                Symbol token = takeFirstSendOrPeekClosed.tryResumeSend(null);
                                                if (token != null) {
                                                    break;
                                                } else {
