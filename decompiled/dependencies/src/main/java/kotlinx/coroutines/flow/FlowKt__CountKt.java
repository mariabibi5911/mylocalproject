            ...
            if ((flowKt__CountKt$count$1.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (flowKt__CountKt$count$12.label) {
                    case 0:
                        ...
                        FlowCollector<? super Object> flowKt__CountKt$count$2 = new FlowKt__CountKt$count$2<>(i2);
                        flowKt__CountKt$count$12.L$0 = i2;
                        flowKt__CountKt$count$12.label = 1;
                        if (flow.collect(flowKt__CountKt$count$2, flowKt__CountKt$count$12) == coroutine_suspended) {
