    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1<T> implements FlowCollector, SuspendFunction {
            ...
            public static final class C00441 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00441(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C00441> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00441(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }
                ...
                */
                public final Object invokeSuspend(Object obj) {
                    C00441 c00441;
                    Object mo1657receiveCatchingJP2dKIU;
                    Object obj2;
                    C00441 c004412;
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c00441 = this;
                            c00441.label = 1;
                            mo1657receiveCatchingJP2dKIU = c00441.$second.mo1657receiveCatchingJP2dKIU(c00441);
                            if (mo1657receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            FlowCollector flowCollector2 = c00441.$this_unsafeFlow;
                            if (!(mo1657receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                                Throwable m1668exceptionOrNullimpl = ChannelResult.m1668exceptionOrNullimpl(mo1657receiveCatchingJP2dKIU);
                                if (m1668exceptionOrNullimpl == null) {
                                    throw new AbortFlowException(flowCollector2);
                                }
                                throw m1668exceptionOrNullimpl;
                            }
                            Function3<T1, T2, Continuation<? super R>, Object> function3 = c00441.$transform;
                            T1 t1 = c00441.$value;
                            if (mo1657receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                mo1657receiveCatchingJP2dKIU = null;
                            }
                            c00441.L$0 = flowCollector2;
                            c00441.label = 2;
                            Object invoke = function3.invoke(t1, mo1657receiveCatchingJP2dKIU, c00441);
                            if (invoke == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            C00441 c004413 = c00441;
                            obj2 = obj;
                            obj = invoke;
                            c004412 = c004413;
                            ...
                            c004412.L$0 = null;
                            c004412.label = 3;
                            return flowCollector.emit(obj, c004412) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            c00441 = this;
                            ResultKt.throwOnFailure(obj);
                            mo1657receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                            FlowCollector flowCollector22 = c00441.$this_unsafeFlow;
                            if (!(mo1657receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                            }
                            break;
                        case 2:
                            ...
                            c004412.L$0 = null;
                            c004412.label = 3;
                            if (flowCollector.emit(obj, c004412) != coroutine_suspended) {
                            }
                            break;
                        case 3:
                            ResultKt.throwOnFailure(obj);
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        switch (combineKt$zipImpl$1$1$2$1$emit$12.label) {
                            case 0:
                                ...
                                Object obj = this.$cnt;
                                C00441 c00441 = new C00441(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
                                combineKt$zipImpl$1$1$2$1$emit$12.label = 1;
                                if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj, c00441, combineKt$zipImpl$1$1$2$1$emit$12) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                break;
                            case 1:
