    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1705scheduleResumeAfterDelay(timeMillis, cont);
        }
        Object result = cancellable$iv.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1641delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m1642toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1642toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1482compareToLRDsOJo($this$toDelayMillis, Duration.INSTANCE.m1585getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1501getInWholeMillisecondsimpl($this$toDelayMillis), 1L);
        }
        return 0L;
    }
}
