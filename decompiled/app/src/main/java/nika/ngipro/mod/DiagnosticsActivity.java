...
public final class DiagnosticsActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView content = new TextView(this); content.setTextColor(secondaryColor); content.setTextSize(13); content.setText(report.toString(2)); root.addView(content);
        Button export = new Button(this); export.setText("Export diagnostics"); export.setOnClickListener(v -> share(report.toString(2))); root.addView(export);
